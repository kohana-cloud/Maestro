...
class UnaryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServerResponse = channel.unary_unary(
                ...
                request_serializer=unary__pb2.StartHoneypot.SerializeToString,
                response_deserializer=unary__pb2.StartHoneypotResponse.FromString,
                )
...
def add_UnaryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetServerResponse': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=unary__pb2.StartHoneypot.FromString,
                    response_serializer=unary__pb2.StartHoneypotResponse.SerializeToString,
            ),
    }
...
class Unary(object):
    ...
    def GetServerResponse(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/unary.Unary/GetServerResponse',
            unary__pb2.StartHoneypot.SerializeToString,
            unary__pb2.StartHoneypotResponse.FromString,
